...
MAX_QUESTION_LEN = 96      # must match AMELTECH_MAX_QUESTION_LEN in the C++ headers
MAX_ANSWER_LEN = 220       # must match AMELTECH_MAX_ANSWER_LEN in the C++ headers
MAX_CATEGORY_LEN = 24
MAX_ENTRIES = 512

VALID_CATEGORIES = {
    "science", "math", "esp32", "general", "custom"
}
